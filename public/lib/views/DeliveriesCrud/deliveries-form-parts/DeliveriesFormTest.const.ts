export const JSON_INPUT_STYLE = {
	outerBox: { width: '100%', border: '1px solid #6f6f6f' },
	warningBox: {
		background: '#949494',
		width: '100%',
	},
...
export const JSON_INPUT_COLORS = {
	background: 'white',
	// seems to not be in typings hence 'as any'
	error: 'red',
	default: '#081f2c',
} as any;
...
export const JSON_INPUT_THEME_BE_LOCALE = {
