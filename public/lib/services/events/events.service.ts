import { EventOptionSchema } from './events.service.types';

export const EVENTS_PATH = 'event-registry/v1/event-registry';

export class EventsAPIService {
	// TODO-KS REMOVE MOCK
	public async fetchAll(): Promise<EventOptionSchema[]> {
		...
		// return api
		// 	.get(`${EVENTS_PATH}?page=${page}&pagesize=${pagesize}&sort=${sort || 'name'}`)
		// 	.json();
	}
}
